                            ...
                            <div class="table-responsive">
                                <table class="table table-striped mb-0">
                                    ...
                                    @forelse ($compras_soles as $compra_soles)
                                        <tr class="{{$compra_soles->deleted_at ? 'text-danger' : ''}}">
                                            ...
                                            <td>{{$compra_soles->deleted_at ? $compra_soles->deleted_at : ''}}</td>
                                        </tr>
                                    @empty
                                        <tr>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped mb-0">
                                    ...
                                    @forelse ($compras_dolares as $compra_dolares)
                                        <tr class="{{$compra_dolares->deleted_at ? 'text-danger' : ''}}">
                                            ...
                                            <td>{{$compra_dolares->deleted_at ? $compra_dolares->deleted_at : ''}}</td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="9" class="text-center text-muted"><span>No se encontraron resultados</span></td>
